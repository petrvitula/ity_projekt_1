...
\newlength{\normalheight}
\setlength{\normalheight}{24.1cm} % Normální výška

\newlength{\overflowheight}
\setlength{\overflowheight}{24.4cm} % Výška v případě přetečení obsahu
...
\begin{adjustwidth}{0.77cm}{0.80cm}
    ...
    \underline{tím profesionálněji} bude \textbf{\fontfamily{pzc}\selectfont dokument} vypadat. Čtenář tím bude {\textbf{{\LARGE vždy}}} {\textbf{{\LARGE nadšen!}}}
    \medskip
\end{adjustwidth}
...
Balíček \verb|fontenc| slouží ke korektnímu kódovaní znaků s~diakritikou, aby bylo možno v textu vyhledávat a ko\-pí\-ro\-vat z něj.
